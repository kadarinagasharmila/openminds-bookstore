...
<body style="padding-top:130px;">  <!-- FIXED NAV OFFSET -->
...
<!-- Featured -->
<h2 class="section-title-home">Featured Books</h2>
...
<div class="container my-5">
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card book-card-home">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Master DSA with easy explanations and real-world examples.</p>
                    <p class="price-tag">₹499</p>
                    <button class="btn btn-buy w-100" onclick="addToCart('Data Structures & Algorithms', 499, 'book1.jpg')">Add to Cart</button>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card book-card-home">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">A complete guide to OS concepts for beginners & experts.</p>
                    <p class="price-tag">₹430</p>
                    <button class="btn btn-buy w-100" onclick="addToCart('Operating Systems', 450, 'book2.jpg')">Add to Cart</button>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card book-card-home">
                <img src="book3.jpg" class="card-img-top" alt="Book Image">
                <div class="card-body">
                    <h5 class="card-title">Database Management Systems</h5>
                    <p class="card-text">Understand DBMS deeply with SQL & theory breakdowns.</p>
                    <p class="price-tag">₹389</p>
                    <button class="btn btn-buy w-100" onclick="addToCart('Database Management Systems', 389, 'book3.jpg')">Add to Cart</button>
                </div>
            </div>
        </div>
